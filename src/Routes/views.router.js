...
import { accessAdmin, accessUser } from "../middleware/auth.js";
...
router.get("/products", passport.authenticate("current", {session: false}), accessUser, async (req, res) => {
    try {
...
router.get("/realTimeProducts",passport.authenticate("current", {session: false}), accessAdmin, (req, res) => {
